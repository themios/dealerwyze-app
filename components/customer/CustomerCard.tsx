...
import { Phone, Mail, Paperclip } from 'lucide-react'
    ...
    <>
      <div className="flex items-stretch">
        <Link href={`/customers/${customer.id}`} className="flex-1 min-w-0">
          <Card className="card-hover rounded-r-none border-r-0">
        ...
        {/* Quick-upload paperclip button */}
        <button
          onClick={() => setUploadOpen(true)}
          className="flex items-center justify-center w-10 border border-l-0 rounded-r-lg bg-card hover:bg-accent transition-colors text-muted-foreground hover:text-primary flex-shrink-0"
