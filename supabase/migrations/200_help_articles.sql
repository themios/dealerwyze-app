...
'Click **Leads** in the left sidebar, then click the **Add Lead** button in the top right. Choose your entry method (manual, scan, paste, or CSV), enter their name and phone number, then click **Save**. You can add email, address, and notes later. Your new customer appears in your **Leads** list immediately.',
'dealer', array['leads', 'customers'], array['add', 'customer', 'lead', 'new', 'create'],
'[{"label": "Leads List", "page": "/leads"}, {"label": "Settings", "page": "/settings"}]'::jsonb),

('add-client-re', 'How do I add a new client?',
'Click **Leads** in the left sidebar, then click the **Add Lead** button in the top right. Enter their name and phone number, then click **Save**. You can add email, address, and notes later. Your new client appears in your **Leads** list immediately.',
'real_estate', array['leads'], array['add', 'client', 'new', 'create', 'prospect', 'lead'],
'[{"label": "Leads List", "page": "/leads"}, {"label": "Settings", "page": "/settings"}]'::jsonb),

('add-vehicle-dealer', 'How do I add a vehicle to inventory?',
'Go to the **Inventory** page, click the **Add Vehicle** button, and enter the VIN or year/make/model. Add the price, mileage, and any notes. Vehicles show up in your available list right away. You can attach photos later.',
...
'Go to the **Listings** page, click the **Add Listing** button, and enter the address. Add bedrooms, bathrooms, sqft, price, and MLS number if available. Upload photos, and your listing goes live. You can edit anytime before or after marketing.',
...
'Open a customer detail page, click the **Send Text** or **SMS** button near the top. Type your message and hit Send. The message goes from your dealership/agency number. You can see all messages in the customer''s activity timeline.',
...
'Open a customer detail page, click the **Send Email** button near the top. Write your message, add a template if you''d like, and Send. The email goes from your business email and shows in the activity log.',
...
'Open a customer detail page, click the **Add Activity** or **+ Log Note** button. Choose the type (call, email, text, note, viewing, etc.), add details, and Save. All activities appear in the customer''s timeline so you never lose track of conversations.',
...
'Open the vehicle detail page, click the **Share Vehicle** button, select how you want to send it (SMS, email, or copy link), and choose your customer. They''ll get a link to view photos, details, and price—no account needed.',
...
'Open the listing detail page, click the **Share Listing** button, choose SMS or email, pick your client, and send. They''ll get a beautiful link to view all photos, details, and price. Easy for showings.',
...
'Open the vehicle or listing detail page, scroll to the **Photos** section, and click the **+ Upload Photos** button. You can drag-and-drop or select files. Reorder them by dragging. The first photo becomes the main image.',
...
'Open a listing (RE) or vehicle (dealer) detail page, click the **Schedule Showing** or **Schedule Test Drive** button. Pick a date and time, add the client/customer, and add any notes. Your calendar updates and you can share the details with them.',
...
'Go to **Settings**, click **Team** in the left menu, then click the **+ Invite Team Member** button. Enter their email, choose their role (admin, manager, agent, viewer), and Send. They''ll get an email to join. You control what they can see and do.',
...
'Go to **Settings**, click **Account** in the left menu, then click the **Change Password** button. Enter your current password, then your new password twice. Click Save and you''re all set.',
...
'Go to **Settings**, click **Data** in the left menu, then click the **Export Data** button. Choose your date range and what to include (customers, vehicles/listings, activities, transactions), and Download. You''ll get a CSV or Excel file.',
