...
/**
 * Remotion Lambda calls this URL when serverless rendering completes (`renderMediaOnLambda` webhook).
 * Same secret must be configured as `RENDER_WEBHOOK_SECRET` and passed in the Lambda call.
 */
