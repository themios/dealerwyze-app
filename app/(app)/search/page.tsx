    ...
    <div>
      ...
      <div className="px-4 py-3">
        <div className="relative">
          ...
          <Input
            placeholder="Name, phone, stock #, make…"
            value={query}
      ...
      {query.length < 2 ? (
        <div className="text-center py-16 text-muted-foreground">
          ...
          <p className="text-sm">Search customers, vehicles, stock numbers…</p>
        </div>
      ) : loading ? (
        ...
        <div className="px-4 space-y-4">
          {customers.length > 0 && (
            <section>
              <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-2">Customers</p>
