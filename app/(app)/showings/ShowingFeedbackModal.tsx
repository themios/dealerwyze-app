...
export function ShowingFeedbackModal({ showing, onClose, onSubmitted }: ShowingFeedbackModalProps) {
  ...
  // Desktop: custom modal with bottom positioning
  if (isDesktop) {
    return (
  ...
  // Mobile/Tablet: use side sheet (right side)
  return (
    <Sheet open={true} onOpenChange={onClose}>
      <SheetContent side="right" className="max-h-[90vh] overflow-y-auto w-full sm:max-w-md">
        <SheetHeader>
          <SheetTitle>Showing Feedback</SheetTitle>
          <SheetDescription>Record feedback about this showing</SheetDescription>
        </SheetHeader>
        {formContent}
      </SheetContent>
    </Sheet>
